(ns domappl.phase
  "Phase 0->3 staged rollout for the domestic-appliance
  ...
  `domappl.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Domestic Appliance Plant Operations Governor verdict to a
