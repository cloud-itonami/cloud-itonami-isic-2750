# Operator Quickstart — Manufacture of domestic appliances

Shortest path from clone to a verified local dry-run for **ISIC 2750** (`cloud-itonami-isic-2750`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2750.git
cd cloud-itonami-isic-2750
```
...
- Blueprint governor key: `domestic-appliance-plant-operations-governor`
- Likely source path: `domappl.governor.cljc`
