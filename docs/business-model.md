# Business Model: Manufacture of domestic appliances
...
## Classification
- Repository: `cloud-itonami-isic-2750` ([github.com/cloud-itonami/cloud-itonami-isic-2750](https://github.com/cloud-itonami/cloud-itonami-isic-2750))
- ISIC Rev.5: `2750` — Manufacture of domestic appliances
- Domain: `:domestic-appliances/manufacturing`
- Social impact: :worker-safety :product-safety :consumer-electrical-safety
- Actor: `:domestic-appliance-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :domestic-appliances/manufacturing — who wants
...
One managed tenant (:domestic-appliances/manufacturing):
...
- Do not bypass the `:domestic-appliance-plant-operations-governor` for production decisions.
